...
class DoctorslotsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        for ($currentDate = $Variable1; $currentDate <= $Variable2;$currentDate += (86400)) {
            ...
            $array[] = $Store;
        //    return $day = Carbon::createFromFormat('d/m/Y', $Store)->format('l');
            $days[] = $day = date('l', strtotime($Store));
        }
        // return $dayofweek = date('w', strtotime($array));
        ...
        // if ($run) {
             ...
             $slotrecord   = Doctorslots::whereBetween('date', [$request->from, $request->to])->get();
             return $slotrecord->date;
            return $dayy[] = date('l', strtotime($slotrecord->date));
