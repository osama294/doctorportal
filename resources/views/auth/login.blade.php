            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In to <a href="{{ route('login') }}"><span class="brand-name">Doctor.uk</span></a></h1>
                        <!-- s<p class="signup-link">New Here? <a href="auth_register.html">Create an account</a></p> -->
                        ...
                        <p class="terms-conditions">© 2022 All Rights Reserved. <a href="{{url('home')}}">Doctor.uk</a> is a product of Designreset. <a href="javascript:void(0);">OBS</a>, <a href="javascript:void(0);">Privacy</a>, and <a href="javascript:void(0);">Terms</a>.</p>
