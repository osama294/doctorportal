                                ...
                                <div class="col-md-3 col-sm-3">
                                    @if($doctors->image)
                                        <label>Profile Image</label>
                                            <div>
                                                <img src="{{asset($doctors->url)}}" alt="" class="img-circle" id="preview-image-before-upload" src="https://www.riobeauty.co.uk/images/product_image_not_found.gif" style="max-height: 220px; width:100%;">
                                            </div>
                                        ...
                                        @else
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <img alt="No Image" class="img-circle" id="preview-image-before-upload" style="height:220px; width:100%;" src="https://www.riobeauty.co.uk/images/product_image_not_found.gif">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="2 Years" name="work_experience" value="{{$doctors->work_experience}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label>Education</label>
                                                <input type="text" class="form-control" name="education" value="{{$doctors->education}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" rows="2">{{$doctors->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
