                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group-sm">
                                            ...
                                            @if($app->appoinment_type == 'Call')
                                                <a href="{{url('video_chat')}}?doctor_name={{Auth::user()->name}}&rommId={{$app->room_name}}" class="btn btn-primary"><i class="fa fa-video"></i></a>
                                            @elseif($app->appoinment_type == 'Chat')
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-9">
                        <div class="card component-card_1">
                            <div class="card-body">
                                    <h2 class="text-center">Appoinment Details</h6>
                                <div class="row">
                                    <div class="col-6">
    ...
    function PateintAppoinment(patientid,doctorid,appoinmentid){
        ...
        $.ajax({ 
            ...
            success: function(data){
                ...
                $("#patientname").html(data.appoinment.patient.name); 
                    $("#end_time").html(data.appoinment.slot.end_time); 
                    $("#start_time").html(data.appoinment.slot.start_time); 
                    $("#date").html(data.appoinment.slot.date);
            },
