 ...
 <div id="content" class="main-content">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-one">
                            <div class="widget-heading">
                                <h6 class="">Total Doctors</h6>
                            </div>
                            <div class="w-chart">
                                <div class="w-chart-section">
                                    <div class="w-detail">
                                        <!-- <p class="w-title">Total Doctors</p> -->
                                        <p class="w-stats">{{$total_docotr}}</p>
                                    </div>
                                ...
                                <!-- <div class="w-chart-section">
                                    <div class="w-detail">
                                        <p class="w-title">Total Patient</p>
                                        <p class="w-stats">{{$total_patient}}</p>
                                    </div>
                                    <div class="w-chart-render-one">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-one">
                            ...
                            <div class="w-chart">
                                <div class="w-chart-section">
                                    <div class="w-detail">
                                        <p class="w-title">Available Slots</p>
                                ...
                                <div class="w-chart-section">
                                    <div class="w-detail">
                                        <p class="w-title">Booked Slots</p>
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2022 <a target="_blank" href="http://obstechnologia.com/">OBS Technologia</a>, All rights reserved.</p>
                </div>
